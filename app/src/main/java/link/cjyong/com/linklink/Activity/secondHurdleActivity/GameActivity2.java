...
public class GameActivity2 extends Activity
{
                ...
                .setNegativeButton("取消",new DialogInterface.OnClickListener()
                        {
                            public void onClick(DialogInterface dialog, int which)
                            {
                                Intent  intent = new Intent(GameActivity2.this, SecondHurdleActivity.class);
        ...
        soundBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(MyApplication.getBackIsOn()==1)
                {
                    ...
                    soundBack.setImageResource(R.drawable.soundback2);
                    //发送暂停信息
                    Intent intent = new Intent(GameActivity2.this,BackgroundMusicService.class);
        ...
        settingAD = new AlertDialog.Builder(this)
                ...
                .setNegativeButton("返回", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        //切换背景音乐
                        /*
                        Intent tintent = new Intent(GameActivity2.this,BackgroundMusicService.class);
    ...
    private void handleSuccessLink(LinkInfo linkInfo, Piece prePiece, Piece currentPiece, Piece[][] pieces) {
        ...
        this.gameView.postInvalidate();
        this.gameService.movePieces(prePiece,currentPiece);
        this.selected = null;
